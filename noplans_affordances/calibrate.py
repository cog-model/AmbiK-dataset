...
from noplans_affordances.pipeline import AffordancesConfig, AffordancesPipe
...
def calibration():
    ...
    for sample in calibration_set:
        ...
        row = {'id':sample['id'], 'task':sample['action'], 'all variants': sample['options'],
    ...
    calib_data.to_csv('calib_data/noplans_LAP_' + gen_model + '_' + answ_model +'.csv')
